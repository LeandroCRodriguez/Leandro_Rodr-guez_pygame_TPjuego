...
class FormMenuB(Form):
    def __init__(self,name,master_surface,x,y,w,h,color_background,color_border,active):
        ...
        ######CREACION DE BOTONES#####MASTER SUPERF,POS X,Y/ANCHO W ALTO H/BACKGR,COLOR FONDO/COLOR BORDE/¿NO HAY IMAGEN FONDO?/ON_CLICK LLAMA A LA FUNC. APRETO O NO EL BOT/PARAM DEL BOTON/TEXTO, FUENTE, TAMAÑO Y COLOR 
